...
> Documento de estado del proyecto. Última actualización: 2026-07-19 (reorganización docs sección D).
...
- **Rama**: `dx-dependencies` (2 commits). Docs: `docs/catalogo-clinico.md`, `docs/motor-criterios.md`, `docs/flujo-pasos.md`, `docs/arquitectura/uml-diagrams.md`, `docs/clinico/dudas-raquel-pendientes.md` §9–10.
...
- **PROMPT 3 — Corrección de bugs en STOPP cardiovascular** ✅
  Auditoría de los 49 sub-criterios STOPP-B contra la guía oficial STOPP/START v3 (fuente: `docs/clinico/STOPP_START_CRITERIOS_CONTEXTO.md`). Eliminados 9 criterios inventados/redundantes. 404/404 tests en verde.
...
- **PROMPT 6 — START cardiovascular** ✅
  ...
  3. **START-B7**: sin cambios (ya modelaba "sin deterioro grave de función renal" vía `labs.egfr_ml_min_173 > 30`, lógica permisiva intencionada). Apuntada duda menor en `docs/clinico/dudas-raquel-pendientes.md`.
  ...
  8. **Unificación variantes IC**: ampliada duda #6 en `docs/clinico/dudas-raquel-pendientes.md`, no aplicada.
...
Auditoría contra `docs/clinico/STOPP_START_CRITERIOS_CONTEXTO.md`. **9 eliminaciones** en `src/assets/data/criteria.json`:
...
Esto es **por diseño**. Ver [duda #6 en docs/clinico/dudas-raquel-pendientes.md](docs/clinico/dudas-raquel-pendientes.md): el tutor propone unificar las 5 variantes en una sola con subopciones combinables (Estable/Sintomática/FE preservada/FE reducida). Si Raquel lo aprueba sería un refactor estructural que afectaría a ~12 criterios. Hasta entonces, **mantener el comportamiento actual**, no es bug.
...
- **Una sola fuente de verdad para STOPP/START**: `docs/clinico/STOPP_START_CRITERIOS_CONTEXTO.md`. No usar conocimiento externo del modelo ni buscar online sin pedir permiso.
