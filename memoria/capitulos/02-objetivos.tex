...
\textbf{Alcance:} batería de tests del motor y de la aplicación, más
comprobación de que los criterios se comportan según el texto de la guía;
no constituye un ensayo clínico ni una validación con perfil clínico.
...
\begin{itemize}
  ...
  contraste con la guía oficial. No se realiza revisión con perfil clínico,
  ni un ensayo, ni un estudio de impacto asistencial sobre pacientes reales.
\end{itemize}
