...
los fármacos del paciente; el motor evalúa el caso y marca cada evento
STOPP/START como activo o inactivo. En diagnóstico se completa la
comorbilidad y el motor vuelve a evaluar, con la misma distinción entre
evento STOPP/START activo e inactivo.
...
incrementos pequeños y verificables, y se contrasta en cada sprint
...
En la práctica, el trabajo se organizó en sprints sucesivos. El primero
se dedicó a planificar y conocer el problema: la guía STOPP/START v3, el
alcance y lo que debía quedar fuera. El segundo construyó una interfaz
sobre la que poder revisar el caso. A partir de ahí, cada sistema clínico
fue un sprint: se añadían sus criterios, se contrastaban con la guía y se
dejaba el prototipo ejecutable antes de pasar al siguiente. El último
sprint concentró pruebas y modificaciones pequeñas. El detalle de
planificación, horas y desviaciones se recoge en
el~\cref{cap:planificacion}; la batería de pruebas, en
el~\cref{cap:pruebas}.
