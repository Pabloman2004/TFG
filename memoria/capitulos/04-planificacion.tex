...
la actividad reconstruida hasta el 16 de agosto de 2026 (barras oscuras).
Esta última procede del histórico de Git y no equivale a un registro
horario. El método de trabajo que justifica ese
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[
    ...
    % --- Memoria (plan 4.00--6.00; actividad observada hasta el corte) ---
    \node[anchor=east, font=\scriptsize\sffamily]
    ...
    \node[anchor=west, font=\scriptsize\sffamily] at (2.65, 17.85)
      {Actividad hasta 16/08};
  \end{tikzpicture}
  \caption{Cronograma del proyecto (marzo--agosto de 2026): barras claras,
  planificación inicial; barras oscuras, actividad reconstruida mediante Git
  hasta el 16 de agosto. La fase de pruebas se solapa con la implementación.
  La redacción no se presenta como cerrada en esa fecha.}
