...
Tres decisiones de diseño se han revelado acertadas. La primera es
mantener las reglas clínicas fuera del código: el motor aplica
...
La segunda es usar los tests como especificación clínica, no solo como
red de seguridad del software~\cite{beck2002tdd}. Un falso negativo ---un
aviso que debería saltar y no salta--- es el riesgo dominante en este
dominio; formular el caso y el resultado esperado antes de implementar
la regla convirtió esa expectativa en un contrato ejecutable. El detalle
de la batería está en el~\cref{cap:pruebas}.
...
superficie de privacidad. El coste, aceptado en
...
importación JSON. La analítica sí se captura en la pestaña «Otros» del
paso de diagnósticos; lo que no puede activarse a mano es, sobre todo,
lo que depende de la edad. El recuento del catálogo (218 subcriterios
en \texttt{criteria.json}) no coincide 1:1 con los 190 enunciados de la
guía: algunos se desglosan en varias reglas y otros no se reflejan con
la misma granularidad. Por último, las dependencias diagnósticas y las
familias de variantes se curaron en profundidad en cardiovascular e
hipertensión; el resto de sistemas no tiene el mismo grado de
especialización.
...
antes habría alineado antes el modelo, las pruebas y el uso en consulta.

En conjunto, el proyecto enseña que el valor de una herramienta de
apoyo no está en acumular funciones, sino en acotar el alcance, hacer
comprobables las reglas y dejar fuera ---de forma explícita--- lo que
aún no puede defenderse.
