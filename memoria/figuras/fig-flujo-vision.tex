\begin{figure}[H]
  ...
  \begin{tikzpicture}[
    ...
    decision/.style={
      diamond, draw, thick, align=center, aspect=2.15,
      inner sep=2.5pt, fill=gray!6, font=\scriptsize\sffamily
    },
    seccion/.style={
    ...
    \draw[arr] (salta.west) -| (si.north);
    \draw[arr] (salta.east) -| (no.north);
    ...
    \draw[arr] (salta2.west) -| (si2.north);
    \draw[arr] (salta2.east) -| (no2.north);
  ...
  evalúa el caso y marca cada evento STOPP/START como activo o inactivo; el resultado
